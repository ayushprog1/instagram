...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://instagram-zo7q.onrender.com/api/v1/user/profile/edit', formData, {
                headers: {
            ...
            if (res.data.success) {
                const updateduserdata = {
                    ...user,
                    bio: res.data.User?.bio ,//?? user.bio, // Use existing value if undefined
        ...
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full my-8' >
                ...
                <div className='flex items-center justify-between bg-gray-100 rounded-xl p-4'>
                    ...
                    <Button onClick={() => imageRef?.current.click()} className='bg-[#0095F6] h-8 hover:bg-[#318bc7]'>Change Picture</Button>
                </div>
                <div>
